      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          ...
          <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
            We're building an amazing community space where PR professionals can connect, share insights, and learn from each other. The community forum will be available soon.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <ul className="text-left space-y-2 text-gray-700 max-w-md mx-auto">
              <li className="flex items-start">
                ...
                Discussion forums on PR topics
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                Networking with fellow PR professionals
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
